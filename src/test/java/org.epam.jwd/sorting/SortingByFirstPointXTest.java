...
public class SortingByFirstPointXTest {
    ...
    private final InMemoryPlainRepository firstRepo = InMemoryPlainRepository.getInstance();
    private final Sorting sortingByFirstPointX = new SortingByFirstPointX();
    private final Plain firstPlain = new Plain(new Point3d(BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO),
    ...
    private final Plain secondPlain =  new Plain(new Point3d(new BigDecimal("2"), BigDecimal.ZERO, BigDecimal.ZERO),
            new Point3d(BigDecimal.ZERO, new BigDecimal("3"), BigDecimal.ZERO),
            new Point3d(BigDecimal.ZERO, BigDecimal.ZERO, new BigDecimal("4")));
    private final Plain thirdPlain = new Plain(new Point3d(new BigDecimal("10"), BigDecimal.ZERO, BigDecimal.ZERO),
    ...
    private List<Plain> initSortedPlains() {
        return List.of(
                new Plain(new Point3d(BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO),
                        new Point3d(new BigDecimal("4"), BigDecimal.ZERO, new BigDecimal("2")),
                        new Point3d(BigDecimal.ZERO, new BigDecimal("4"), new BigDecimal("1"))),
                new Plain(new Point3d(new BigDecimal("2"), BigDecimal.ZERO, BigDecimal.ZERO),
                        new Point3d(BigDecimal.ZERO, new BigDecimal("3"), BigDecimal.ZERO),
                        new Point3d(BigDecimal.ZERO, BigDecimal.ZERO, new BigDecimal("4"))),
                new Plain(new Point3d(new BigDecimal("10"), BigDecimal.ZERO, BigDecimal.ZERO),
                        new Point3d(BigDecimal.ZERO, new BigDecimal("2"), BigDecimal.ZERO),
                        new Point3d(BigDecimal.ZERO, BigDecimal.ZERO, new BigDecimal("1")))
        );
    }
