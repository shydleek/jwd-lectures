...
public class SortByFirstPointYWithComparatorTest {

    private PlainRepository repo;
    private final SortByFirstPointYWithComparator sortingByFirstPointY = new SortByFirstPointYWithComparator();
    ...
    private final Plain secondPlain = new Plain(
            null,
            new Point3d(new BigDecimal("2"), new BigDecimal("1"), BigDecimal.ZERO),
    ...
    private final Plain thirdPlain = new Plain(
            null,
            new Point3d(new BigDecimal("10"), new BigDecimal("2"), BigDecimal.ZERO),
    ...
    public void sort_shouldReturnSortedList() {
        repo.sort(sortingByFirstPointY);
