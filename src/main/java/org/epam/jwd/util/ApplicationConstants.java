...
public enum ApplicationConstants {
    ...
    PATH_TO_CORRECT_FILE("src/main/java/org/epam/jwd/data/inputCorrectCoefficient.txt"),
    PATH_TO_INCORRECT_FILE("src/main/java/org/epam/jwd/data/inputIncorrectCoefficient.txt");;
