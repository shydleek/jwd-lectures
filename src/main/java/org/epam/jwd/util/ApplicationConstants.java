...
public enum ApplicationConstants {
    ...
    PATH_TO_CORRECT_FILE_COEFFCIENT("src/test/resources/inputCorrectCoefficient.txt"),
    PATH_TO_INCORRECT_FILE_COEFFCIENT("src/test/resources/inputIncorrectCoefficient.txt"),
    ;
